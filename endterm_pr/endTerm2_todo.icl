...
bracketsStars 0 a = ""
bracketsStars a 0 = ""
bracketsStars a b = faux a +++ bracketsStars a (b-1)

faux :: Int -> String
faux 0 = ""
faux a = "[" +++ faux (a-1) +++ "*" //+++ faux (a-1)
...
//tailWord :: String -> String
//tailWord str = {toLower e \\ e<-tl[i \\ i<-:str]}

capitalize::String -> String
capitalize "" = ""
capitalize str = {hd[toUpper e \\ e<-ls]}+++{ch \\ch<-([toLower e \\ e<-tl (ls) ])}
where ls = [i \\ i<-:str]
//Start = tailWord "aABCDEFG"
...
:: Course = {name::String, major::Major, credits::Int}n
...
checkSorted :: [a] -> Bool | Eq, Ord a
checkSorted ls = ls == sort ls

sortedMerge :: [a] [a] -> [a] | Eq, Ord a
sortedMerge l1 l2
| checkSorted l1 && checkSorted l2= merge l1 l2
| checkSorted l1 = l1
| checkSorted l2 = l2
= []
...
//createStudTree [] = Leaf
//createStudTree [x:xs] = (Node (Student x.s_name x.grades)) createStudTree xs)
