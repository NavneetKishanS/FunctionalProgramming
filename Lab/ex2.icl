...
//IsEvenDecimal x y = (toInt(10.0*x) rem 2 == 0) && (toInt(10.0*y) rem 2 ==0)
...
| x == 4 = "Four"
| x == 5 = "Five"
| otherwise = "Not less than or equal to 5"
...
//b = (x-365) / 7
//c = (x-365) rem 7
= toString(x / 365) +++ " year" +++ toString((x-365) /7 ) +++ " week" +++ toString((x-365) rem 7) +++ " days"
